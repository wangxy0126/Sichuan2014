...
#upset(comm4inext_abun, sets = c("NF", "MP", "BB", "EC", "JC"), nintersects = 70, group.by = "sets", cutoff = 7, keep.order = TRUE) ## without CL
upset(comm4inext_abun, sets = c("NF", "MP", "BB", "EC", "JC"), nintersects = 70, group.by = "sets", cutoff = 9, keep.order = TRUE) ## without CL
upset(comm4inext_abun, sets = c("NF", "MP", "BB", "EC", "JC"), nintersects = 70, group.by = "sets", keep.order = TRUE) ## without CL
