...
# no longer need this because we have used phyloseq to filter out small OTUs
gsub("[[:punct:][:space:]]", "-", Sys.time()) #time will be show
source("https://bioconductor.org/biocLite.R") # install phyloseq package
biocLite("phyloseq")
...
## from above result, we decide use 2 threshold to filter those small otus: 120 (>=120) and 40 (>=40)
