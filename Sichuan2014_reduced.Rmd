...
with(habitatNforest, ordisurf(communityBforest.jmds, sprichness, main="All beta diversity", cex=0.5, col = "grey"))
...
multi.all <- list(JCNF = JCNF.multi.dist, BBNF = BBNF.multi.dist, ECNF =  ECNF.multi.dist, MFNF = MFNF.multi.dist)
